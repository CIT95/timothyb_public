...
def button_square():
    number = e.get()
    e.delete(0, END)
    e.insert(0, float(number) * float(number))
...
button_clear = Button(root, text="Clear", padx=31, pady=20,
...
button_square = Button(root, text="^2", padx=37, pady=20,
                       command=button_square)
button_root = Button(root, text="√", padx=39, pady=20,
                     command=button_root)
